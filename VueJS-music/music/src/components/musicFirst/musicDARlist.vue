<template>
  <div class="offlists">
    ...
    <div class="box">
      <div class="content">
        <div v-for="(item,index) in offarry2" :key="index" class="song_item">
...
export default {
  data() {
    return {
      offlist:
        this.HOST +
        "/v1/restserver/ting?method=baidu.ting.billboard.billList&type=1&size=6&offset=6",
  ...
  mounted() {
    ...
    this.$axios
      .get(this.offlist2, { params: { order: "new", limit: 10 } })
      .then(res => {
        //console.log(res);
